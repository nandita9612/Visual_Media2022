...
class Snake(object):
    ...
    def draw(self, screen):
        red, green, blue = 50 / (self.length - 1), 100, 100 / (self.length - 1)
...
class Game(object):
    def __init__(self):
        ...
        self.feed = Feed()
        self.speed = 20
        self.background_image = pygame.image.load("/Users/nanditakothari/Desktop/Sogang 22-2/Visual Media/pygame/field.jpg")
        self.background_image = pygame.transform.scale(self.background_image, (SCREEN_WIDTH, SCREEN_HEIGHT))
        pygame.mixer.music.load ("/Users/nanditakothari/Desktop/Sogang 22-2/Visual Media/pygame/snake_bgm.ogg")
    ...
    def check_eat(self, snake, feed):
        if snake.positions[0] == feed.position:
            eating_sound = pygame.mixer.Sound("/Users/nanditakothari/Desktop/Sogang 22-2/Visual Media/pygame/eating.ogg")
            eating_sound.play()
            snake.eat()
            feed.create()
    ...
    def draw_info(self, length, speed, screen):
        ...
        font_path = resource_path("/Users/nanditakothari/Desktop/Sogang 22-2/Visual Media/pygame/new_Snake_Game/assets/NanumGothicCoding-Bold.ttf")
